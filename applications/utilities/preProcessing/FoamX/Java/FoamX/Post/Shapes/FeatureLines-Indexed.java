...
public class FeatureLines extends Shape3D implements InteractiveNode
{
    ...
    public FeatureLines(int patch, float angle)
    {
        ...
        IndexedLineArray axisLines = null;
        ...
        if (patch_ == 0)
        {
            ...
            axisLines = new IndexedLineArray
            (
                5,
            ...
            axisLines.setCoordinate( 2, coords[2]);
            axisLines.setCoordinate( 3, coords[3]);
            axisLines.setCoordinate( 4, coords[4]);

            axisLines.setCoordinateIndices( 0, vertexLabels_);

            axisLines.setColors(0, colors);
            axisLines.setColorIndex( 0, UNPICKEDCOLOR);
            axisLines.setColorIndex( 1, UNPICKEDCOLOR);
            axisLines.setColorIndex( 2, UNPICKEDCOLOR);
            axisLines.setColorIndex( 3, UNPICKEDCOLOR);
            axisLines.setColorIndex( 4, UNPICKEDCOLOR);
        }
        else if (patch_ == 1)
        {
            vertexLabels_ = new int[10];
        ...
        else if (patch_ == 2)
        {
            ...
            axisLines.setCoordinate( 3, coords[4]);
        ...
        else if (patch_ == 5)
        {
            ...
            axisLines.setCoordinate( 3, coords[1]);
        ...
        else if (patch_ == 6)
        {
            ...
            axisLines.setCoordinate( 3, coords[0]);
        ...
        axisLines.setCapability(IndexedLineArray.ALLOW_COLOR_WRITE);
        axisLines.setCapability(IndexedLineArray.ALLOW_COLOR_INDEX_WRITE);
    ...
    void printLoop()
    {
        ...
        for(int j = 0; j < lines.getVertexCount(); j++)
        {
            System.out.println("--- color : " + lines.getColorIndex(j));
        }
    }
