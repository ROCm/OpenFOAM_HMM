...
void Foam::CV2D::newPoints(const scalar relaxation)
{
    ...
    )
    {
        ...
        //Info<< "DirsA " << alignmentDirsA[0] << " " << alignmentDirsA[1] << endl; 
        ...
        //Info<< "DirsB " << alignmentDirsB[0] << " " << alignmentDirsB[1] << endl; 
        ...
        //Info<< "Dirs " << alignmentDirs[0] << " " << alignmentDirs[1] << endl; 
