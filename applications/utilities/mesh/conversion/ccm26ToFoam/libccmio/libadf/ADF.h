...
#if defined (_WIN32) && ! defined(ADFLIB)
...
DllExport	void	ADF_Children_Names(
			const double PID,
			const int istart,
			const int ilen,
...
DllExport	void	ADF_Children_IDs(
			const double PID,
			const int istart,
			const int ilen,
			int *ilen_ret,
...
DllExport	void	ADF_Create(
			const double PID,
			const char *name,
			double *ID,
			int *error_return ) ;

DllExport	void	ADF_Database_Close(
			const double ID,
			int *error_return ) ;

DllExport	void	ADF_Database_Delete(
			const char *filename,
			int *error_return ) ;

DllExport	void	ADF_Database_Garbage_Collection(
			const double ID,
			int *error_return ) ;

DllExport	void	ADF_Database_Get_Format(
			const double Root_ID,
			char *format,
			int *error_return ) ;

DllExport	void	ADF_Database_Open(
			const char *filename,
			const char *status,
			const char *format,
			double *root_ID,
...
DllExport	void	ADF_Database_Version(
			const double Root_ID,
			char *version,
			char *creation_date,
...
DllExport	void	ADF_Delete(
			const double PID,
			const double ID,
			int *error_return ) ;

DllExport	void	ADF_Error_Message(
			const int error_return_input,
			char *error_string ) ;

DllExport	void	ADF_Flush_to_Disk(
			const double ID,
			int *error_return ) ;

DllExport	void	ADF_Get_Data_Type(
			const double ID,
			char *data_type,
			int *error_return ) ;

DllExport	void	ADF_Get_Dimension_Values(
			const double ID,
			int dim_vals[],
			int *error_return ) ;
...
DllExport	void	ADF_Get_Label(
			const double ID,
			char *label,
			int *error_return ) ;

DllExport	void	ADF_Get_Link_Path(
			const double ID,
			char *filename,
			char *link_path,
			int *error_return ) ;

DllExport	void	ADF_Get_Name(
			const double ID,
			char *name,
			int *error_return ) ;

DllExport	void	ADF_Get_Node_ID(
			const double PID,
			const char *name,
			double *ID,
			int *error_return ) ;

DllExport	void	ADF_Get_Number_of_Dimensions(
			const double ID,
			int *num_dims,
			int *error_return ) ;

DllExport	void	ADF_Get_Root_ID(
			const double ID,
			double *Root_ID,
			int *error_return ) ;

DllExport	void	ADF_Is_Link(
			const double ID,
			int *link_path_length,
			int *error_return ) ;

DllExport	void	ADF_Library_Version(
			char *version,
			int *error_return ) ;

DllExport	void	ADF_Link(
			const double PID,
			const char *name,
			const char *file,
...
DllExport	void	ADF_Move_Child(
			const double PID,
			const double ID,
			const double NPID,
			int *error_return ) ;

DllExport	void	ADF_Number_of_Children(
			const double ID,
			int *num_children,
			int *error_return ) ;
...
DllExport	void	ADF_Put_Name(
			const double PID,
			const double ID,
			const char *name,
			int *error_return ) ;

DllExport	void	ADF_Read_All_Data(
			const double ID,
			char *data,
			int *error_return ) ;

DllExport	void	ADF_Read_Block_Data(
			const double ID,
            const long b_start,
            const long b_end,
			char *data,
...
DllExport	void	ADF_Set_Error_State(
			const int error_state,
			int *error_return ) ;

DllExport	void	ADF_Set_Label(
			const double ID,
			const char *label,
			int *error_return ) ;
...
DllExport	void	ADF_Write_Block_Data(
            const double ID,
            const long b_start,
            const long b_end,
            char *data,
